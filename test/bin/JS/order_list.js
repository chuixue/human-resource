...
function getOrderColumns(listId){
	...
	var i=0;
	var cols=[[ 
	{field:F[i].id,width:ws[0],title:F[i++].name,align:'center',hidden:true,editor:'numberbox',sortable:true},//订单号
	{field:F[i].id,width:ws[0],title:F[i++].name,align:'center',hidden:true,editor:'text',sortable:true },	//菜品
	{field:F[i].id,width:ws[0],title:F[i++].name,align:'center',hidden:true,editor:'numberbox'}, 					//桌号
	{field:F[i].id,width:ws[0],title:F[i++].name,align:'center',hidden:true,editor:'text',sortable:true }, 	//厨师
	{field:F[i].id,width:ws[0],title:F[i++].name,align:'center',hidden:true,editor:'numberbox',sortable:true}, 	//数量
	{field:F[i].id,width:ws[0],title:F[i++].name,align:'center',hidden:true,editor:'text'}, 				//用户
	{field:F[i].id,width:ws[0],title:F[i++].name,align:'center',hidden:true,editor:'text'}, 				//备注
	{field:F[i].id,width:ws[0],title:F[i++].name,align:'center',hidden:true,editor:'text'}, 				//打印状态
	{field:F[i].id,width:ws[0],title:F[i++].name,align:'center',hidden:true,editor:'datebox'}, 				//时间
	{field:F[i].id,width:ws[0],title:F[i++].name,align:'center',hidden:true,editor:'text'}, 				//用户交互
	{field:F[i].id,width:ws[0],title:F[i++].name,align:'center',hidden:true,editor:'text', 				//操作
