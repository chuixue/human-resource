    ...
    function order_pro(){
		var data = [];		
		  data = [  {oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" },
                    {oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" },
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"0",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"0",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
     ...
     $.ajax({
		url: 'http://cins.swpu.edu.cn:8003/orderinfo',  //跨域请求请加域名前缀：http://cins.swpu.edu.cn:8003
		dataType: "jsonp",	 
		...
		success: function(data){    var j=0;
		   ...
		   var data_after=[];
               for(var i=0;i<j;i++){
				   data_after[i]={oid:"1",did:"",uid:"",onlykey:"",ostate:"",ohelp:"",omark:"",obtime:"",optime:"",opid:""}
			   }
            var k=0;
		
		    for(var i=0;i<data.length;i++){
				if(data[i].ostate==1){
					data_after[k].oid=data[i].oid;
					data_after[k].did=data[i].did;
					data_after[k].uid=data[i].uid;
					data_after[k].onlykey=data[i].onlykey;
					data_after[k].ostate=data[i].ostate;
					data_after[k].ohelp=data[i].ohelp;
					data_after[k].omark=data[i].omark;
					data_after[k].obtime=data[i].obtime;
    ...
    var cs = new table({
        "tableId":"cs_table",    	 
        "headers":["订单编号","菜品id","用户id","唯一标识" ,"状态","是否代点","备注","点餐时间","上餐时间","操作人员" ],   //必须
        "data":data_after,         
        "displayNum": 6,     
       "groupDataNum":9   
    });
	...
	function order_unpro(){
		 var data = [];		
		  data = [  {oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" },
					...
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"0",ohelp:"",omark:"",obtime:"",optime:"",opid:"" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"0",ohelp:"",omark:"",obtime:"",optime:"",opid:"" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
					{oid:"1001",did:"123",uid:"han",onlykey:"12",ostate:"1",ohelp:"1",omark:"12",obtime:"9.10",optime:"11.10",opid:"3" }, 
